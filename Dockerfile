...
WORKDIR /go/src/github.com/cloudification-io/gardener-extension-shoot-flux
...
LABEL org.opencontainers.image.source="https://github.com/cloudification-io/gardener-extension-shoot-flux"
